    ...
    public function show(Request $request)
    {
        ...
        return response()->json([
            ...
            'data' => [
                ...
                'is_magang_selesai' => ! \App\Services\PeriodeMagangService::apakahAktif($user),
                'admin_email' => \App\Models\User::where('role', 'admin')->value('email') ?? 'admin@poltek-furnitur.ac.id',
