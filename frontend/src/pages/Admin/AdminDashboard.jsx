...
const AdminDashboard = () => {
  ...
  return (
    <div className="space-y-6 max-w-7xl mx-auto">
      ...
      {/* ── BENTO CARD 3: INTERACTIVE MANAGEMENT MODULES (2 CARDS) ── */}
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 items-stretch">
        ...
        <div className="card-bento p-6 flex flex-col justify-between space-y-4 hover:border-amber-300 transition-all group">
          ...
          <div className="pt-3 border-t border-slate-100 flex items-center justify-between">
            ...
            <button
              onClick={() => navigate('/admin/kelola-user')}
              className="btn-poli-primary px-4 py-2 rounded-xl text-xs uppercase tracking-wider font-extrabold flex items-center gap-1.5 shadow-xs"
            >
